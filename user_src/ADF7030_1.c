...
void ADF7030Init_NoReset(void)
{
    ...
    ADF7030_WRITE_REGISTER_NOPOINTER_LONGADDR_MSB(ADDR_GENERIC_FIELDS, PROFILE_GENERIC_FIELDS_32bit_200004FC);
...
void RX_ANALYSIS(void)
{
	...
	if(Flag_ERROR_Read==0)//���쳣������ȡ������������������ʱ�����������ա����롣
	{
...
**/
	void ADF7030_Change_Channel(void)
	{
        ...
        PROFILE_GENERIC_FIELDS_32bit_200004FC = 0xC010000B;
		PROFILE_GENERIC_PKT_FRAME_CFG1_32bit_20000500 = 0x8004100C;	
		Radio_Date_Type=1;
		Channels=1;
...
*/
			  ...
			  case 3:
				   ...
				   PROFILE_RADIO_AFC_CFG1_32bit_2000031C = 0x0005005B;
                    ...
                    PROFILE_GENERIC_FIELDS_32bit_200004FC = 0xC010000C;
					PROFILE_GENERIC_PKT_FRAME_CFG1_32bit_20000500 = 0x8004101C;
					Radio_Date_Type=2;
					Channels=4;
